...
import 'package:crypto_questor/view/screens/sign_in_page/mixin/sign_in_form_fields_mixin.dart';
import 'package:crypto_questor/view/screens/sign_in_page/widget/sign_up_link_widget.dart';
import 'package:provider/provider.dart';
import 'package:crypto_questor/view/widgets/empty_widget.dart';
import 'package:crypto_questor/view/screens/sign_in_page/widget/wallet_image_widgets.dart';
import 'package:crypto_questor/view/widgets/project_decoration/project_box_decorations.dart';
  ...
  Padding _buildPasswordPart(double myWidht, BuildContext context, UserProvider userProvider) {
    return Padding(
      ...
      child: Container(
        decoration: ProjectBoxDecorations.signPagesBoxDecoration,
        child: TextFormField(
          decoration: ProjectInputDecorations.signInPagePasswordFieldWithVisibilityInputDecoration(context, passwordVisibility, togglePasswordVisibility),
          style: ProjectInputDecorations.signPagesInputDecorationTextStyle(context),
          obscuringCharacter: '*',
