...
final class CustomColors {
  ...
  static  Color coinsCardColor = const Color(0xff0B255B).withOpacity(0.4);
  static const  List<Color> cardGradientColors = [Color(0x99FFFFFF), Color(0x00FFFFFF), Color(0x00FFFFFF), Color(0x99FFFFFF),];
