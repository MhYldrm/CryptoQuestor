...
class GeckoModelSpaklineIn7DModel {
  GeckoModelSpaklineIn7DModel({required this.price});
  ...
  final List<double> price; // List of prices over the last 7 days, part of the [sparklineIn7D] data
  ...
  Map<String, dynamic> toJson() => {"price": List<dynamic>.from(price.map((x) => x)),};
}
