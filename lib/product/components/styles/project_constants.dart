/// [ProjectConstants] contains static constants and URLs used throughout the app.
...
final class ProjectConstants {
  ...
  /// The default boolean value created for the D, M, 3M, 6M, Y options in the chart on the Coin Detail Page.
  /// Here, D is set to true since 'day' is selected by default.
  static const timesBool = [true, false, false, false, false, false];
